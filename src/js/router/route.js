...
(function() {
    ...
    Router.prototype = {
        init: function(config) {
            ...
            //console.log("init :" +  this.routerViewId);
            /*if (name) {
        ...
        changeView: function(currentHash) {
            ...
            if (this.historyFlag === 'back') {
                ...
                //console.log(currentPage+ " "+enterName);
                ...
                if(this.routes[currHash].callback){
                    this.routes[currHash].callback(currentHash);
                }else{
                    console.log("null");
                }
            }
            ...
            if (this.routes[currentHash.path]) {
                ...
                if (this.beforeFun) {
                    this.beforeFun({
                        ...
                        next: function() {
                            //console.log("router currentHash: " + JSON.stringify(currentHash));
        ...
        map: function() {
            ...
            //console.log(JSON.stringify("routs map: " + this.routerMap));
        },
        //切换之前的钩子
